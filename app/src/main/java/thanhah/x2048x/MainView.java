...
public class MainView extends View {
    ...
    public MainView(Context context) {
        ...
        try {
            ...
            this.setBackground(resources.getDrawable(R.drawable.background_image));
    ...
    private void drawUndoButton(Canvas canvas, boolean lightUp) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.drawable.ic_undo),
